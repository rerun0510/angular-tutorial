...
describe('SidenavComponent', () => {
  ...
  describe('#ngOnInit', () => {
    it('should init', () => {
      const expectedMenuListResponseDtos: MenuListResponseDto[] = createExpectedMenu();
      accountServiceSpy.getMenu.and.returnValue(of(expectedMenuListResponseDtos));

      component.ngOnInit();
      expect(component.menuListResponseDto).toEqual(expectedMenuListResponseDtos);
...
function createExpectedMenu() {
  ...
  const expectedMenuListResponseDtos: MenuListResponseDto[] = Array(menuListResponseDto1, menuListResponseDto2);
  return expectedMenuListResponseDtos;
}
